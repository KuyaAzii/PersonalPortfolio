...
import headerImg from "../assets/img/bannerss.png";
...
export const Banner = () => {
  ...
  const toRotate = [ "FullStack Developer", "IT Technician" ];
  const period = 2000;
            ...
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                <p>Seeking a challenging position in a reputable organization where I can learn new skills,
                      ...
                      to the growth of the organization, which will launch my career and build a valuable skillset.</p>
